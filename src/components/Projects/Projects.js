        ...
        <div className='projectsBackground'>
            <div className='projectsContainer'>
                ...
                <div className='projectsList'>
                    ...
                    <Project pname='Speedfire Games' pdescription='This one was developed using ReactJS, emulating a basic videogame e-commerce' pid='2' ppid='p2' arrow='a2' techs={['ReactJS', 'CSS', 'JS', 'Firebase']} status={statusList[0]} img='https://i.imgur.com/tMXBmzz.jpg' link='https://speedfire.vercel.app/' />
                    <Project pname='Speedfire Backend' pdescription='A remake of Speedfire Games, but emphasizing in the backend area' pid='3' ppid='p3' arrow='a3' techs={['EJS', 'CSS', 'JS', 'MongoDB', 'Express', 'Websocket']} status={statusList[1]} img='' link='/projects' />
                    ...
                    <Project pname='Old portfolio' pdescription='I really needed an upgrade' pid='7' ppid='p7' arrow='a7' techs={['HTML', 'CSS', 'JS']} status={statusList[0]} img='https://i.imgur.com/Nn0Y6MS.png' link='https://binaryjuan.github.io/portfolio/' />
                </div>
            </div>
        </div>
    )
